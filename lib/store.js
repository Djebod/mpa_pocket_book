...
// Training, Tabel Premi, Resume, Tabel Medical) — masing-masing disimpan
// sebagai teks JSON di kolomnya sendiri di Sheets, dengan guard ukuran
// yang sama seperti field lampiran lain (kalau belum ter-upload ke
// Drive, masih base64 raksasa, jangan dikirim supaya tidak memutus
// sinkronisasi).
const PRODUCT_FILE_FIELDS = ["materiTraining", "tabelPremi", "resume", "tabelMedical"];
