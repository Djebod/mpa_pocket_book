...
const BASE_SECTIONS = [
  { href: "/dashboard/activities", label: "Catat Aktivitas", desc: "Catat aktivitas baru & lihat riwayat aktivitas Anda." },
  { href: "/dashboard", label: "Ringkasan Aktivitas", desc: "Ringkasan jumlah aktivitas Anda per jenis + riwayat terbaru." },
  { href: "/dashboard/team", label: "Tim Saya", desc: "Lihat aktivitas anggota tim yang menjadikan Anda Direct Leader." },
];

const ADMIN_SECTION = {
  href: "/dashboard/admin/activities",
  label: "Ringkasan Aktivitas Tim",
  desc: "Data lengkap seluruh aktivitas member, filter, sort, dan export Excel.",
};

export default function AktivitasMenuPage() {
